...
class Component {
    /**
     * @typedef {{componentID: string, componentType: Discord.ComponentType, permission: Discord.PermissionsString, acceptRoles: string[] execute: ExecuteFuctions}} ComponentOptions
